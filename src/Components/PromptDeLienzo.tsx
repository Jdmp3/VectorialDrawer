...
function Prompteador({
  ...
  return (
    <div
      className={`relative z-50 bg-sky-500 text-amber-50 mx-auto w-72 text-center p-6 rounded-[20px] border-sky-800 border-6 transition-all duration-3500 ease-in-out ${
